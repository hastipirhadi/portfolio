...
const About = () => {
  const stats = [
    ...
    { number: "2+", label: "CERTIFICATES & COURSES" },
  ];

  return (
    <section id="home" className="mb-20 w-full max-w-7xl mx-auto lg:text-left ">
      {/* TITLE */}
      ...
      {/* DESCRIPTION */}
      <p className="w-full max-w-3xl text-gray-500 text-center lg:text-left lg:text-xl leading-relaxed mx-auto lg:mx-0">
        Frontend Developer focused on building responsive, modern, and
        user-friendly web experiences. Currently developing my skills through
        hands-on projects and nearly a year of intensive Frontend Development
        training, with a strong interest in React, Next.js, and modern frontend
        technologies.
      </p>
      ...
      <div className=" mt-10 flex w-full min-w-0 flex-col gap-6 md:flex-row ">
        {/* CARD 1 */}
        <div className=" group relative min-w-0 w-full flex-1 overflow-hidden min-h-[180px] md:min-h-[248px] bg-[#1c1b19]/40 backdrop-blur-xl border border-white/[0.05] rounded-[2rem] p-6 sm:p-8 md:p-10 flex flex-col justify-between transition-all duration-500 hover:border-orange-500/40 hover:bg-orange-500/[0.03] hover:shadow-[0_20px_40px_-15px_rgba(249,115,22,0.15)] ">
          ...
          <div className="relative z-10">
            <h1 className=" text-white font-bold text-xl sm:text-[1.5rem] py-3 leading-tight break-words ">
              Design-to-code workflow powered by AI tools
            </h1>
          </div>
        </div>
        {/* CARD 2 */}
